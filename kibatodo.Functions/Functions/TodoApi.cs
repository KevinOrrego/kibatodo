...
using kibatodo.Common.Responses;
using kibatodo.Functions.Entities;
...
namespace kibatodo.Functions.Functions
{
    public static class TodoApi
    {
            ...
            ILogger log)
        {
            ...
            string message = "New todo saved in table";
            ...
            ILogger log)
        {
            ...
            if (findResult.Result == null)
            {
                ...
                {
                    IsSuccess = false,
                    Message = " Todo not found, try with another id"
                });
            }
            ...
            string message = $"Todo: {id}, has been updated";
            ...
            ILogger log)
        {
            ...
            string message = "Here are all your todos mister";
            log.LogInformation(message);
